...
class AppTypography {
  ...
  static TextStyle secondary(TextStyle style) => style.copyWith(color: AppColors.secondary);
  ...
  static TextStyle onPrimary(TextStyle style) => style.copyWith(color: AppColors.surface);
}